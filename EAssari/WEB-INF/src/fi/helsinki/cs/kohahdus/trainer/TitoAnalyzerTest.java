...
/*
	...
	public void testAnalyzeInputsOutputs() {
		 ...
		 * tavan syˆtteell‰ halutaan, ett‰ r1=4, salainen r1=12
		 *                                 r2=-8,         r2=4
		 * kriteerein‰ siis ett‰ tulostuu tavan syˆtteell‰ 4,-8 ja sal 12,4
		*/
		//Create criteria
		criteria1=new LinkedList<Criterion>();
		//outputs
	...
	public void testAnalyzeFillIn() {
		...
		i1.setAcceptanceTestValue("SVC"); //ei k‰ytˆss‰, v‰itt‰‰ v‰‰rin
