...
//GET-METHODS
	...
	//markus huom: nyt lˆytyy metodit getTaskType() ja getTasktype(), joista j‰lkimm‰inen
	//periytyy eAssarista (lˆytyy tuolta alempaa). EAssarin metodi palauttaa tyypin, jolla
	//yhdistet‰‰n Displayer ja Analyzer komponentit Taskiin. Ehk‰ olisi parasta nimet‰ oma
	//metodi uudelleen s.e. sit‰ ei voida sekoittaa eAssarin vastaavaan. 
	//Vaihdoin oman metodin nimeksi get/setTitoTaskType.
	//Allaoleva metodi on turha ja voidaan poistaa nyt kun tyyppi lˆytyy y.o. metodilla.
...
//	 **** NƒMƒ AINAKIN OVAT VANHASTA EASSARISTA *****	
