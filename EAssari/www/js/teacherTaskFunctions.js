...
function writeTaskList() {
	...
	headerHtml += '<td class="titleBar">Language <a href="javascript: sortTasksByLanguage(tasks, true)"><img src="images/arrow-down.gif" border="0"></a><a href="javascript: sortTasksByLanguage(tasks, false)"><img src="images/arrow-up.gif" border="0"></a></td>';
