...
{\tt@param usesSecretInput} true if criterion is to be used in conjunktion to secret input
...
{\tt 	public abstract boolean hasQualityTest(boolean usingModelAnswer)}\\
Return true if this criterion has test for evaluating quality of the student's answer\\

{\tt	public abstract boolean passesQualityTest(TitoState studentAnswer, TitoState modelAnswer)} \\
Return true if student's solution meets the quality requirement of this Criterion\\

{\tt	public abstract String getQualityTestValue()}\\
Return the value the student's answer will be compared to\\
