...
{\tt@param languageBundle} Language dependant parts of crierion names\\
...
{\tt 	public void removeStudentAnswers(String userID)} \\
Removes all student's answers from database (studentmodel and storedanswer).\\
