...
Analyzer ja Displayer luokat. Tauluun on mahdollista tallentaa myös muuta tehtävätyyppikohtaista
tietoa, mutta todennäköistä on että näitä ei tulla käyttämään.

\subsection{task}
Task määrittelee tehtävän. Itse task-taluun tallentaan lähinnä tehtävän nimi ja luojan nimi,
...
tänne, erona on vain status-sarakkeen arvo.
