...
Henkilötiedoissa näytetään salasanaa lukuunottamatta kaikki rekisteröintitiedot.
...
<properties>
	<comment></comment>
	<entry key="kentänNimi_EN">kentän sisältö englannin kielellä</entry>
...
Käsittelee opiskelijan vastausyritykset sekä tallentaa niiden tiedot tietokantaan.
\begin{figure}[ht]
