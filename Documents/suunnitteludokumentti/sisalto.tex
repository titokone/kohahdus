...
tunnus joka on valittu rekisteröidyttäessä. Tämäm toiminnon ei tarvitse toimia opettajien tunnusten
kanssa, mutta odotettavissa on, että opettajatunnusten tukeminen ei aiheuta minkäänlaista lisätyötä.
...
olisi ollut kolme osajärjestelmää, jossa eAssari on TitoTraineria käyttävä sovelluskehys. Tämä
...
TitoTrainer-spesifinen eAssari-versio joka ei ole yhteensopiva geneerisen eAssarin kanssa.
...
tehtävätyyppikohtaista tietoa, mutta ainakaan ensimmäisen iteraation kohdalla tälle ole
näkyvissä tarvetta.

\subsection{task}
Task määrittelee tehtävän. Itse task-tauluun tallentaan lähinnä tehtävän nimi ja luojan nimi.
Tehtävän kriteerit, kuvaus, palautteet yms lisätään yleiskäyttöiseen attributevalues-tauluun.

\subsection{course}
Määrittelee kurssin nimen ja tunnisteen. Tähän tauluun viitataan useista muista taluista,
...
Yhdistää tehtävän kursiin ja moduuliin. Normaalitapauksessa siis tehtävä lisättäisiin
...
virheilmoituksen. Käyttäytyminen poikkeustilanteissa kuvataan tarkemmin
...
\end{figure}
\begin{figure}[h]
	\includegraphics[width=14cm] {sekvenssikaaviot/Käyttäjätietojen muokkaaminen.eps}
